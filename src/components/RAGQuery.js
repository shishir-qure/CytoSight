        ...
        ${answer && "h-[500px] mb-4"}`}>
            ...
            >
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
                    <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Qure Clinical Assistant</h1>
                ...
                <div className="flex gap-2 items-start mb-6">
                    ...
                    <button
                        onClick={handleAsk}
                        disabled={loading}
                        className={`px-4 py-2 rounded text-white font-medium shadow-sm transition ${loading ? "bg-gray-400 cursor-not-allowed" : "bg-teal-600 hover:bg-teal-700"
                            }`}
                    >
                        {loading ? "Asking..." : "Ask"}
                    </button>
                ...
                {answer && (
                    <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm">
                        <h2 className="text-xl font-semibold mb-2 text-teal-700 dark:text-teal-400">🩺 Answer</h2>
                        <ReactMarkdown>
                            {answer}
                        </ReactMarkdown>
                        ...
                        {citations.length > 0 && (
                            <>
                                <h3 className="mt-4 font-semibold text-gray-700 dark:text-gray-300">📚 Citations</h3>
            ...
            {answer && !fullscreen && (
                <div className="absolute bottom-1  left-1/2 transform -translate-x-1/2">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 transform rotate-180" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M10 17a1 1 0 01-.707-.293l-5-5a1 1 0 011.414-1.414L10 14.586l4.293-4.293a1 1 0 111.414 1.414l-5 5A1 1 0 0110 17z" clipRule="evenodd" />
                        </svg>
                    </button>
                </div>
            )}
