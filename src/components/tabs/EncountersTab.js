  ...
  const encounters = [
    {
      ...
      status: "Completed",
      notes: "Patient reports improvement in breathing with current medications. PFT scheduled for next week.",
    },
    {
      ...
      status: "Completed",
      notes: "Chest pain workup negative. EKG normal, troponins negative. Discharged with cardiology follow-up.",
    },
    {
    ...
    },
    {
      ...
      status: "Completed",
      notes: "Overall health stable. Recommended lifestyle modifications and specialist referrals.",
    },
    {
    ...
    },
    {
      ...
      department: "Pharmacy",
      status: "Completed",
      notes: "Reviewed all medications for interactions. Patient counseled on proper inhaler technique.",
    },
    {
      ...
      status: "Completed",
      notes: "Patient completed 6-week pulmonary rehab program. Significant improvement in exercise tolerance.",
    },
  ]
          ...
          {encounters.map((encounter, index) => (
            <div key={index} className="bg-gray-800 rounded-lg p-6">
              <div className="flex justify-between items-start mb-4">
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">{encounter.title}</h3>
                  <div className="text-gray-400 text-sm mb-2">{encounter.date}</div>
                  <span className="bg-blue-600 text-white px-2 py-1 rounded text-xs">{encounter.department}</span>
                </div>
                <span className="bg-green-600 text-white px-3 py-1 rounded text-sm">{encounter.status}</span>
              </div>
              ...
              <div className="bg-gray-700 rounded p-3">
                <h4 className="text-sm font-medium text-gray-300 mb-2">Clinical Notes:</h4>
